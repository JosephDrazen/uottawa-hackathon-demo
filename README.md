...
4. Create a cluster if using Kind
   ...
   **NOTE: If you are using rancherdesktop, then you have already created the cluster during install. You will not need to use Kind.**

    Run a command to create a new Kubernetes cluster. For example, we're using kind to create a cluster called sm-workshop-cluster. If you used rancherdesktop, the context/cluster will be named `rancherdesktop`
...
11. Login to argocd with the password from Step 7

12. Find your `test-app` and click refresh
